...
namespace CS230
{
	...
	public:
		 ...
		 */
		void Draw(const Math::TransformationMatrix& display_matrix, unsigned int color = 0xFFFFFFFF, float depth = DrawDepth::CHARACTER);
		 ...
		 */
		void Draw(const Math::TransformationMatrix& display_matrix, Math::ivec2 texel_position, Math::ivec2 frame_size, unsigned int color = 0xFFFFFFFF, float depth = DrawDepth::CHARACTER);
