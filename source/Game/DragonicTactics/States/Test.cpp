...
void Test::Load()
{
    DataRegistry::Instance().LoadFromFile("../../source/Assets/Data/characters.json");
    ...
    Engine::GetLogger().LogEvent("'J' -> Test JSON | 'R' -> Reload | 'L' -> Log All Keys");
    LogFighterStatus();
    LogDragonStatus();
}
...
void Test::Update([[maybe_unused]] double dt)
{
    ...
    if (Engine::GetInput().KeyJustPressed(CS230::Input::Keys::R))
    {
        ...
        DataRegistry::Instance().ReloadFile("../../source/Assets/Data/characters.json");
