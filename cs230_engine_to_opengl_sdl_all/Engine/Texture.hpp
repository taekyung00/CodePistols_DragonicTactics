...
namespace CS230
{
    ...
    private:
        // Core texture data - OpenGL handle and size information
        // These form the essential state needed for all texture operations
        OpenGL::TextureHandle textureHandle = {}; // OpenGL texture object handle
        Math::ivec2           size{};             // Texture dimensions in pixels
    };
}
