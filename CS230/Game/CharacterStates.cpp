...
void State_TurnEnd::Enter(CS230::GameObject* object) {
    // 턴 종료 상태에 들어왔을 때의 로직...
}
void State_TurnEnd::Update(CS230::GameObject* object, double dt) {
    // 턴 종료 애니메이션 등을 여기서 처리...
}
void State_TurnEnd::CheckExit(CS230::GameObject* object) {
    // 다음 턴으로 넘어가는 등의 조건...
}